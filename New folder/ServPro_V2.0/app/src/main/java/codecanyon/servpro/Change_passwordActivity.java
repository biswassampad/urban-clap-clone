...
public class Change_passwordActivity extends AppCompatActivity {
    ...
    /**
     * Attempts to change password in or register the account specified by the change password form.
     * If there are form errors (invalid email, missing fields, etc.), the
     * errors are presented and no actual change password attempt is made.
     */
