...
public class Offers_detailActivity extends CommonAppCompatActivity {
    ...
    private TextView tv_title, tv_from_date, tv_detail, tv_offer_code;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_from_date.setText(CommonAppCompatActivity.getConvertDateTime(start_date, 2) + getResources().getString(R.string.to) + CommonAppCompatActivity.getConvertDateTime(end_date, 2));
        ...
        iv_copy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ClipData clip = ClipData.newPlainText("servproCode", tv_offer_code.getText().toString());
