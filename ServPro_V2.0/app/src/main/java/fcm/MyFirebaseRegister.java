...
public class MyFirebaseRegister {
    ...
    public void RegisterUser(String user_id) {
        ...
        FirebaseMessaging.getInstance().subscribeToTopic("servpro");
    ...
    private void makeRegisterFCM(String user_id, String token) {
        ...
        CommonAsyTask task = new CommonAsyTask(BaseURL.POST, params,
            ...
            public void VResponce(String response) {
                Log.e(_context.toString(), (response != null) ? response : "null");
            }

            @Override
            public void VError(String responce) {
                Log.e(_context.toString(), (responce != null) ? responce : "null");
            }
        }, false, _context);
        task.execute();
    }
